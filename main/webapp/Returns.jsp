...
<%
    ...
    if (!Boolean.TRUE.equals(loggedIn) || customer == null) {
        response.sendRedirect("CustomerLogin.jsp?redirect=Returns.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<title>Returns & Refunds — SIBS Store</title>
...
<body>
<nav class="top-nav">
  <a href="Customer" class="nav-back"><i class="bi bi-arrow-left"></i></a>
...
<div class="page-wrap">
  <div class="cs-card">
    <div class="cs-icon"><i class="bi bi-arrow-counterclockwise"></i></div>
    <div class="cs-badge"><i class="bi bi-stars"></i> Upgrade in Progress</div>
    <h1 class="cs-title">Returns & Refunds is Coming Soon</h1>
    <p class="cs-subtitle">Our hassle-free return portal is under construction. You'll be able to raise returns, track refund status, and get resolutions in minutes.</p>
    <div style="display:flex;justify-content:center;flex-wrap:wrap;gap:.5rem;">
      <a href="Customer" class="btn-primary-cs"><i class="bi bi-house-fill"></i> Continue Shopping</a>
      <a href="CustomerProfile" class="btn-outline-cs"><i class="bi bi-person-circle"></i> My Account</a>
    </div>
    <div class="quick-links">
      <a href="CustomerOrdersServlet" class="ql-item"><span class="ql-icon"><i class="bi bi-box-seam"></i></span><span class="ql-text">My Orders</span></a>
      <a href="CustomerWallet" class="ql-item"><span class="ql-icon"><i class="bi bi-wallet2"></i></span><span class="ql-text">My Wallet</span></a>
      <a href="WishlistServlet" class="ql-item"><span class="ql-icon"><i class="bi bi-heart"></i></span><span class="ql-text">Wishlist</span></a>
      <a href="HelpDesk" class="ql-item"><span class="ql-icon"><i class="bi bi-headset"></i></span><span class="ql-text">Help & Support</span></a>
    </div>
  </div>
</div>
...
window.addEventListener('load',function(){
  ...
  div.innerHTML='<i class="bi bi-info-circle-fill" style="color:#f5a623;"></i> Returns & Refunds is being crafted — launching soon!';
