...
<%
    ...
    if (!Boolean.TRUE.equals(loggedIn) || customer == null) {
        response.sendRedirect("CustomerLogin.jsp?redirect=HelpCenter.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<title>Help Center — SIBS Store</title>
...
<div class="page-wrap">
  <div class="cs-card">
    <div class="cs-icon"><i class="bi bi-book-half"></i></div>
    <div class="cs-badge"><i class="bi bi-stars"></i> Knowledge Base Coming</div>
    <h1 class="cs-title">Help Center is Coming Soon</h1>
    <p class="cs-subtitle">A comprehensive self-service knowledge base — FAQs, how-tos, and troubleshooting guides — is being built for you. For now, our live Help Desk has you covered.</p>
...
window.addEventListener('load',function(){
  ...
  div.innerHTML='<i class="bi bi-info-circle-fill" style="color:#f5a623;"></i> Help Center is being crafted — launching soon!';
