...
<%
    ...
    if (!Boolean.TRUE.equals(loggedIn) || customer == null) {
        response.sendRedirect("CustomerLogin.jsp?redirect=ContactUs.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<title>Contact Us — SIBS Store</title>
...
<div class="page-wrap">
  <div class="cs-card">
    <div class="cs-icon"><i class="bi bi-chat-dots-fill"></i></div>
    <div class="cs-badge"><i class="bi bi-stars"></i> Almost Ready</div>
    <h1 class="cs-title">Contact Us is Coming Soon</h1>
    <p class="cs-subtitle">A dedicated contact hub is on its way. In the meantime, our live Help Desk can answer any questions you have right now.</p>
...
window.addEventListener('load',function(){
  ...
  div.innerHTML='<i class="bi bi-info-circle-fill" style="color:#f5a623;"></i> Contact Us is being crafted — launching soon!';
