...
<%
    ...
    if (!Boolean.TRUE.equals(loggedIn) || customer == null) {
        response.sendRedirect("CustomerLogin.jsp?redirect=Coupons.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<title>Coupons & Offers — SIBS Store</title>
...
<div class="page-wrap">
  <div class="cs-card">
    <div class="cs-icon"><i class="bi bi-ticket-perforated-fill"></i></div>
    <div class="cs-badge"><i class="bi bi-stars"></i> Great Things Coming</div>
    <h1 class="cs-title">Coupons & Offers is Coming Soon</h1>
    <p class="cs-subtitle">We're building an exclusive coupons centre with flash deals, member discounts, and referral rewards just for you.</p>
...
window.addEventListener('load',function(){
  ...
  div.innerHTML='<i class="bi bi-info-circle-fill" style="color:#f5a623;"></i> Coupons & Offers is being crafted — launching soon!';
