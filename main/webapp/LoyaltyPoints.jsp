...
<%
    ...
    if (!Boolean.TRUE.equals(loggedIn) || customer == null) {
        response.sendRedirect("CustomerLogin.jsp?redirect=LoyaltyPoints.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<title>Loyalty Rewards — SIBS Store</title>
...
<div class="page-wrap">
  <div class="cs-card">
    ...
    <div class="cs-badge"><i class="bi bi-stars"></i> Earning Your Rewards</div>
    <h1 class="cs-title">Loyalty Rewards is Coming Soon</h1>
    <p class="cs-subtitle">Every purchase you make earns you points. We're building a full rewards dashboard where you can redeem them for discounts, free shipping, and more.</p>
...
window.addEventListener('load',function(){
  ...
  div.innerHTML='<i class="bi bi-info-circle-fill" style="color:#f5a623;"></i> Loyalty Rewards is being crafted — launching soon!';
