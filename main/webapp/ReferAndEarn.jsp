...
<%
    ...
    if (!Boolean.TRUE.equals(loggedIn) || customer == null) {
        response.sendRedirect("CustomerLogin.jsp?redirect=ReferAndEarn.jsp");
        return;
    }
%>
<!DOCTYPE html>
...
<title>Refer & Earn — SIBS Store</title>
...
<div class="page-wrap">
  <div class="cs-card">
    ...
    <div class="cs-badge"><i class="bi bi-stars"></i> Sharing is Rewarding</div>
    <h1 class="cs-title">Refer & Earn is Coming Soon</h1>
    <p class="cs-subtitle">Know someone who'd love SIBS Store? Soon you'll be able to share a unique link, earn wallet credits for every signup, and unlock exclusive referral bonuses.</p>
...
window.addEventListener('load',function(){
  ...
  div.innerHTML='<i class="bi bi-info-circle-fill" style="color:#f5a623;"></i> Refer & Earn is being crafted — launching soon!';
